...
CREATE TABLE `projm` (
  ...
  `Prj_Client` varchar(150) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL,
  `Prj_PMC` varchar(75) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL,
  `Prj_Contract` varchar(75) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL,
  ...
  `Prj_Approve` varchar(75) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL,
...
-- Dump completed on 2022-05-09 13:31:41
